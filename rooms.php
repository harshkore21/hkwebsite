              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <div class="d-flex">
                  <div class="me-3">
                    ...
                    <input type="number" min="1" id="adults" oninput="guests_filter()" class="form-control shadow-none mb-3" value="<?php echo $adult_default ?>">
                  </div>
                  <div>
                    <label for="form-label">Children</label>
                    <input type="number" min="1" id="children" oninput="guests_filter()" class="form-control shadow-none mb-3" value="<?php echo $children_default ?>">
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    function fetch_rooms(){
      ...
      xhr.onprogress = function(){
        rooms_data.innerHTML = `<div class="spinner-border text-dark mb-3 d-block mx-auto" id="loader" role="status">
