...
<body class="bg-light">
  ...
  <div class="container">
    <div class="row">
      ...
      <!-- left side of page to page waypoint -->
          ...
          <form id="info-form">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input name="name" type="text" value="<?php echo $u_fetch['name'] ?>" class="form-control shadow-none" pattern="[A-Za-z\s]+" title="Name must only contain letters, spaces, or hyphens" required>
              </div>
              <div class="col-md-4 mb-3">
                <label class="form-label">Phone Number</label>
                <input name="phonenum" type="text" value="<?php echo $u_fetch['phonenum'] ?>" minlength="10" maxlength="10" pattern="[0-9]{10}" title="Please enter a 10-digit phone number" class="form-control shadow-none" required>
              </div>
              <div class="col-md-4 mb-3">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="pincode" type="text" value="<?php echo $u_fetch['pincode'] ?>" minlength="6" maxlength="6" pattern="\d{6}" title="Pincode must be exactly 6 digits" class="form-control shadow-none" required>
              </div>
