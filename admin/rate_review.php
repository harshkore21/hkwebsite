        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <!-- mark all as read and delete all button -->
                        <div class="text-end mb-4">
                            <a href="?seen=all" class='btn btn-dark rounded-pill shadow-none btn-sm'>
                                <i class="bi bi-check-all me-2"></i>Mark all read</a>
                            <a href="?del=all" class='btn btn-danger rounded-pill shadow-none btn-sm'>
                                <i class="bi bi-trash3 me-2"></i>Delete all</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        while ($row = mysqli_fetch_assoc($data)) {
                                            ...
                                            $seen.= "<a href='?del=$row[sr_no]' class='btn btn-sm rounded-pill btn-danger'>Delete</a><br>";
                                            echo <<<query
                                                <tr>
                                                    <td>$i</td>
                                                    <td>$row[rname]</td>
