<?php 
    ...
    if (isset($_POST['get_bookings'])) 
    {
        ...
        // function to search user in new bookings by entering NAME, PHONE NO. or ORDER ID
    ...
    if (isset($_POST['assign_room']))
    {
        ...
        $res = update($query,$values,'iisi'); // this will update 2 rows so it returns 2
