  ...
  <div class="row">
    ...
    <div class="col-lg-4 p-4">
      ...
      <?php 
        if ($contact_r['wa']!='') {
          echo <<<data
            <a href="$contact_r[wa]" class="d-inline-block text-dark text-decoration-none">
...
<!-- Copyright -->
<h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed By Harsh Kore</h6>
