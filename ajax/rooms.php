<?php 
    ...
    if (isset($_GET['fetch_rooms'])) {
        ...
        // check availability data decoded
        ...
        if ($chk_avail['checkin']!='' && $chk_avail['checkout']!='') 
        {
            ...
            if ($checkin_date == $checkout_date) {
                echo "<h3 class='text-center text-danger'>Invalid Dates! Checkin & Checkout dates cannot be same</h3>";
                exit;
            }
            else if ($checkout_date < $checkin_date) {
                echo "<h3 class='text-center text-danger'>Invalid Dates! Checkout date shouldn't come before Checkin date</h3>";
                exit;
            }
            else if ($checkin_date < $today_date) {
                echo "<h3 class='text-center text-danger'>Invalid Dates! Checkin date cannot come earlier than today</h3>";
                exit;
            }
            else if ($checkin_date < $today_date && $checkout_date < $today_date) {
        ...
        {
            // remove room from filter if all the quantity of specific room is booked  
            if ($chk_avail['checkin']!='' && $chk_avail['checkout']!='') 
                {
            ...
            // remove book now button when site shutdown
            $book_btn = "";
